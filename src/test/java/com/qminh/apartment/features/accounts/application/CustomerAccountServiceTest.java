...
class CustomerAccountServiceTest extends PostgresTestContainer {
	...
	void search_customer_accounts() {
		...
		for (int i = 0; i < 3; i++) {
			var u = new com.qminh.apartment.features.accounts.domain.User();
		...
		assertThat(pageFiltered.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getUsername).contains("cust1");
	}
	...
	void search_customer_accounts_by_multiple_fields() {
		...
		var cust1 = new com.qminh.apartment.features.accounts.domain.User();
		...
		var cust2 = new com.qminh.apartment.features.accounts.domain.User();
		...
		var cust3 = new com.qminh.apartment.features.accounts.domain.User();
		...
		assertThat(pageByUsername.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getUsername).contains("customer1");
		...
		assertThat(pageByEmail.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getEmail).contains("bob.wilson@example.com");
		...
		assertThat(pageByDisplayName.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getDisplayName).contains("Alice Johnson");
		...
		assertThat(pageByPartialDisplayName.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getDisplayName).contains("Charlie Brown");
	...
	void search_customer_accounts_with_null_displayName() {
		...
		var cust = new com.qminh.apartment.features.accounts.domain.User();
		...
		assertThat(pageByUsername.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getUsername).contains("custNoDisplay");
		assertThat(pageByUsername.getContent()).hasSize(1);
		...
		assertThat(pageByEmail.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getEmail).contains("custNoDisplay@example.com");
		assertThat(pageByEmail.getContent()).hasSize(1);
	}
