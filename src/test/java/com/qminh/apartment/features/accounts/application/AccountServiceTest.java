...
class AccountServiceTest extends PostgresTestContainer {
	...
	void search_employee_accounts() {
		...
		assertThat(pageFiltered.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getUsername).contains("saleSearch");
	}
	...
	void search_employee_accounts_by_multiple_fields() {
		...
		assertThat(pageByUsername.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getUsername).contains("saleUser1");
		...
		assertThat(pageByEmail.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getEmail).contains("jane.smith@example.com");
		...
		assertThat(pageByDisplayName.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getDisplayName).contains("John Doe");
		...
		assertThat(pageByPartialDisplayName.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getDisplayName).contains("Admin Manager");
	...
	void search_employee_accounts_with_null_displayName() {
		...
		assertThat(pageByUsername.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getUsername).contains("saleNoDisplay");
		assertThat(pageByUsername.getContent()).hasSize(1);
		...
		assertThat(pageByEmail.getContent()).extracting(com.qminh.apartment.features.accounts.dto.user.UserRes::getEmail).contains("saleNoDisplay@example.com");
		assertThat(pageByEmail.getContent()).hasSize(1);
	}
