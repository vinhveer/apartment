	...
	private static Specification<Property> byDetails(List<PropertyDetailFilterReq> details) {
		return (root, query, cb) -> {
			...
			for (int i = 0; i < details.size(); i++) {
				...
				Root<com.qminh.apartment.features.properties.domain.PropertyDetails> detailRoot = existsSubquery.from(com.qminh.apartment.features.properties.domain.PropertyDetails.class);
