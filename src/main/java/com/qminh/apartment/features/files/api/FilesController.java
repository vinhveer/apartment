...
import com.qminh.apartment.features.files.persistence.StoredFileVariantRepository;
import com.qminh.apartment.features.files.application.IFileService;
import com.qminh.apartment.infrastructure.storage.StoragePort;
...
public class FilesController {
	...
	public ResponseEntity<InputStreamResource> getPrivateVariant(@PathVariable Long id, @PathVariable String key) throws IOException {
		...
		StoredFileVariant variant = variantRepo.findByFile_FileIdAndVariantKey(
			...
			.orElseThrow(() -> new ResourceNotFoundException("File variant not found: " + id + " / " + key));
